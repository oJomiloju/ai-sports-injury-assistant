...
export default function Sidebar() {
  return (
    <aside className="w-64 bg-gray-100 p-5 flex flex-col gap-4 shadow-inner">
      ...
      <Link href="/recovery" className="flex items-center gap-2 text-gray-700 hover:text-black">
        <Activity className="w-5 h-5" /> Injury Recovery
      </Link>
      <Link href="/prevention" className="flex items-center gap-2 text-gray-700 hover:text-black">
        <Shield className="w-5 h-5" /> Prevention Tips
      </Link>
      <Link href="/history" className="flex items-center gap-2 text-gray-700 hover:text-black">
